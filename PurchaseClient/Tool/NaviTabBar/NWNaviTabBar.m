...
#import "NWNaviTabBar.h"
#import "NWNaviTabBarItem.h"
@interface NWNaviTabBar()
...
- (void)layoutSubviews {
    ...
    for (NWNaviTabBarItem *item in [self items]) {
...
- (void)setItems:(NSArray *)items {
    for (NWNaviTabBarItem *item in _items) {
...
- (void)setSelectedItem:(NWNaviTabBarItem *)selectedItem {
