...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    if (fromViewController.sc_isNavigationBarHidden || toViewController.sc_isNavigationBarHidden || fromViewController.sc_isNavigationBarNoNeedTransition || toViewController.sc_isNavigationBarNoNeedTransition) {
        ;
    } else {
