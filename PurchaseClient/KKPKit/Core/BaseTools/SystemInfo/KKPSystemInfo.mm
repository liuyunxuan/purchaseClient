...
//  KKPKit
//
//  Created by 刘特风 on 16/1/6.
//  Copyright © 2016年 kakapo. All rights reserved.
//

#import "KKPSystemInfo.h"
#import "KKPMemoryInfo.h"
#import <ifaddrs.h>
#import <arpa/inet.h>
#include <sys/types.h>
...
@implementation KKPSystemInfo

+ (KKPSystemInfo *)sharedInstance
{
    static KKPSystemInfo * g_instance = nil;
    if (nil == g_instance)
    {
        static dispatch_once_t onceToken;
        dispatch_once(&onceToken, ^{
            g_instance = [[KKPSystemInfo alloc] init];
        });
    }
